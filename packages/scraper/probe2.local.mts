import { openDb, runMigrations, setMeta, getDataMode, countRows } from '@renaisslens/db'
...
console.log('rows ingested — packs:', countRows(db, 'packs'), 'sales:', countRows(db, 'sales'), 'listings:', countRows(db, 'listings'))
